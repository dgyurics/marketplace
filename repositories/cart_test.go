...
func TestFetchCartTotal(t *testing.T) {
	...
	expectedTotal := item1.UnitPrice*int64(item1.Quantity) +
		item2.UnitPrice*int64(item2.Quantity)
	...
	assert.Equal(t, expectedTotal, total, "Expected the calculated total to match")
